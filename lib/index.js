...
class SecureKV {
  ...
  set(key, val) {
    ...
    return _asyncToGenerator(function* () {
      if (!_this2.hasOpened) throw new Error('Must load first.');
  ...
  get(key) {
    ...
    return _asyncToGenerator(function* () {
      if (!_this3.hasOpened) throw new Error('Must load first.');
      return _this3._data[key];
    })();
  }

  inspect() {
    return `<SecureKV: ${this.file}>`;
  }
}
exports.default = SecureKV;